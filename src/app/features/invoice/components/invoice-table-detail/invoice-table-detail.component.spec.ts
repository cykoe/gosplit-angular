...
import { InvoiceTableDetailComponent } from './invoice-table-detail.component';
...
describe('ReceiptListCardComponent', () => {
  let component: InvoiceTableDetailComponent;
  let fixture: ComponentFixture<InvoiceTableDetailComponent>;
  let receiptServiceSpy: jasmine.SpyObj<InvoiceService>;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [InvoiceTableDetailComponent],
      providers: [
        {provide: Router, useValue: routerSpy},
        {provide: MatDialog, useClass: MatDialogMock},
        {provide: InvoiceService, useValue: rsSpy},
      ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InvoiceTableDetailComponent);
    component = fixture.componentInstance;
    receiptServiceSpy = TestBed.get(InvoiceService);
