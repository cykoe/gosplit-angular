...
describe('ReceiptService', () => {
  ...
  //     receiptService.receiptSelected(expectedReceipt.id).subscribe(
  ...
  //     receiptService.receiptSelected('wrongId').subscribe(
  //       (receipt) => {
  ...
  //     const msg = 'err msg';
  //     receiptService.receiptSelected('id').subscribe(
  //       () => fail,
  //       (error) => expect(error.message).toContain(msg),
  //     );
  //
